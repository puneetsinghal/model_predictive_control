...
if __name__ == '__main__':
	...
	axarr[0, 0].set_title('Joint 1 Position', fontsize=20, y=0.9)
	...
	axarr[0, 1].set_title('Joint 2 Position', fontsize=20, y=0.9)
	...
	axarr[1, 0].set_title('Joint 1 Velocity', fontsize=20, y=0.9)
	...
	axarr[1, 1].set_title('Joint 2 Velocity', fontsize=20, y=0.9)
