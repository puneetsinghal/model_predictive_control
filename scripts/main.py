...
if __name__ == '__main__':
    ...
    if traj_type == "pnp":
        ...
        if traj_mode == "minjerk":
            ...
            joint_const = TG.cubicSplineSetup_now(initial_angles, tf, waypoints,t_array=time_array)
    ...
    if(args.plot == "all"):
        ...
        while control_info['tf']-time_from_start> 0:
            ...
            if control_info['type'] == "Cubic":
                # cubic spline 
                pos_v, vel_v, accel_v = TG.cubicSplineStep_now(time_from_start, tf,
                        waypoints, joint_const, t_array=time_array)
            # print(pos_v)
