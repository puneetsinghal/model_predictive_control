...
if __name__ == '__main__':
    ...
    axarr[0].set_xlabel('time', fontsize=15)
    axarr[0].set_ylabel('theta_1', fontsize=15)
    axarr[0].tick_params(labelsize=15)
    axarr[0].grid(True)

    axarr[1].plot(t, traj_joint[:,1])
    axarr[1].set_title('Joint 2 Position')
    axarr[1].set_xlabel('time', fontsize=15)
    axarr[1].set_ylabel('theta_2', fontsize=15)
