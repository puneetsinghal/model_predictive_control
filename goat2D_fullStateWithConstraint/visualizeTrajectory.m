...
%         axis image;
        ...
        hold on;
        h1 = plot(x1(:,1),x1(:,2),'Color', [0 0 0.7],'LineWidth', 5);
        h2 = plot(x1(:,1),x1(:,2),'.', 'MarkerSize', 20, 'Color', [1 0 0]);
        h3 = plot(x2(:,1),x2(:,2),'Color', [0 0 0.7],'LineWidth', 5);
        h4 = plot(x2(:,1),x2(:,2),'.', 'MarkerSize', 20, 'Color', [1 0 0]);
        hold off;
    end
