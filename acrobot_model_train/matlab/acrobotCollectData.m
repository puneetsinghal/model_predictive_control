...
Input_data = zeros(5,train_points);
Output_data = zeros(4,train_points);
...
save('train_data.mat','Input_data','Output_data');
...
Output_data = zeros(4,test_points);
...
save('test_data.mat','Input_data','Output_data');
